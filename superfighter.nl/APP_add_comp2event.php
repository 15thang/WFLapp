    ...
    <form name="form1" method="post" action="" enctype="multipart/form-data">
        <div class="container" style="margin-top:10px;">
            ...
            <table id="table_format" class="table table-bordered">
                <tr>
                    <th class="skip-filter" style="text-decoration: underline">Select competition for event</th>
    ...
    <h2 id="athleteVSh2">
        ...
        <div id="athleteVS2">
            ...
            if (isset($_POST['submit_event_comp'])) {
                ...
                switch($comp_event) {
                    ...
                    case 1:
                        $sql = true;
                        $query = "UPDATE competition SET event1 = '$event_id' WHERE competition_id = '$selected_comp'";
                        mysqli_query($db, $query);
                        break;
                    case 2:
                        $sql = true;
                        $query = "UPDATE competition SET event2 = '$event_id' WHERE competition_id = '$selected_comp'";
                        mysqli_query($db, $query);
                        break;
                    case 3:
                        $sql = true;
                        $query = "UPDATE competition SET event3 = '$event_id' WHERE competition_id = '$selected_comp'";
                        mysqli_query($db, $query);
                        break;
                    case 4:
                        $sql = true;
                        $query = "UPDATE competition SET event4 = '$event_id' WHERE competition_id = '$selected_comp'";
                        mysqli_query($db, $query);
                        break;
                    case 5:
                        $sql = true;
                        $query = "UPDATE competition SET event5 = '$event_id' WHERE competition_id = '$selected_comp'";
                        mysqli_query($db, $query);
                        break;
                    case 6:
                        $sql = true;
                        $query = "UPDATE competition SET event6 = '$event_id' WHERE competition_id = '$selected_comp'";
                        mysqli_query($db, $query);
                        break;
                    case 7:
                        $sql = true;
                        $query = "UPDATE competition SET event7 = '$event_id' WHERE competition_id = '$selected_comp'";
                        mysqli_query($db, $query);
                        break;
                    case 8:
                        $sql = true;
                        $query = "UPDATE competition SET event8 = '$event_id' WHERE competition_id = '$selected_comp'";
                        mysqli_query($db, $query);
                        break;
                    case 9:
                        $sql = true;
                        $query = "UPDATE competition SET event9 = '$event_id' WHERE competition_id = '$selected_comp'";
                        mysqli_query($db, $query);
                        break;
        ...
        <script>
            $('input[type=radio]').click(function() {//jQuery works on clicking radio box
                ...
                window.location.href = "APP_add_comp2event.php?event_id=" + eventID + "&competition_id=" + value2 + "&redcorner_id=0&bluecorner_id=0";
            });
        </script>
        ...
        <script>
            $('input[type=checkbox]').click(function() {//jQuery works on clicking checkbox
                ...
                if (redcorner01 == 1){
                    ...
                    window.location.href = "APP_add_comp2event.php?event_id=" + eventID + "&competition_id=" + compid + "&redcorner_id=" + redcorner_id + "&bluecorner_id=0";
                }
                else if (redcorner01 == 0){
                    var redcorner_id = <?php echo $red_cornerID?>;
                    var bluecorner_id = $(this).val(); //Get the clicked checkbox value
                    window.location.href = "APP_add_comp2event.php?event_id=" + eventID + "&competition_id=" + compid + "&redcorner_id=" + redcorner_id + "&bluecorner_id=" + bluecorner_id;
                }
            });
        </script>