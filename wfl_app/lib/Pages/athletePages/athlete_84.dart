...
class W84 extends StatefulWidget {
  const W84({Key key}) : super(key: key);

  @override
  _W84 createState() => _W84();
}
...
class _W84 extends State<W84> {
  List<Athlete> _notes = List<Athlete>();

  Future<List<Athlete>> fetchNotes() async {
    var url = 'http://superfighter.nl/APP_output_athlete_sort_weight.php?weight=3';
