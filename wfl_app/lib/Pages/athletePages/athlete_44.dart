...
class W44 extends StatefulWidget {
  const W44({Key key}) : super(key: key);

  @override
  _W44 createState() => _W44();
}
...
class _W44 extends State<W44> {
  List<Athlete> _notes = List<Athlete>();

  Future<List<Athlete>> fetchNotes() async {
    var url = 'http://superfighter.nl/APP_output_athlete_sort_weight.php?weight=11';
