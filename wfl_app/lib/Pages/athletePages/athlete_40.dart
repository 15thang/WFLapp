...
class W40 extends StatefulWidget {
  const W40({Key key}) : super(key: key);

  @override
  _W40 createState() => _W40();
}
...
class _W40 extends State<W40> {
  List<Athlete> _notes = List<Athlete>();

  Future<List<Athlete>> fetchNotes() async {
    var url = 'http://superfighter.nl/APP_output_athlete_sort_weight.php?weight=12';
