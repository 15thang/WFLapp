...
class W32 extends StatefulWidget {
  const W32({Key key}) : super(key: key);

  @override
  _W32 createState() => _W32();
}
...
class _W32 extends State<W32> {
  List<Athlete> _notes = List<Athlete>();

  Future<List<Athlete>> fetchNotes() async {
    var url = 'http://superfighter.nl/APP_output_athlete_sort_weight.php?weight=14';
