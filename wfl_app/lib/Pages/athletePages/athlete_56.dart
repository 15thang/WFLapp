...
class W56 extends StatefulWidget {
  const W56({Key key}) : super(key: key);

  @override
  _W56 createState() => _W56();
}
...
class _W56 extends State<W56> {
  List<Athlete> _notes = List<Athlete>();

  Future<List<Athlete>> fetchNotes() async {
    var url = 'http://superfighter.nl/APP_output_athlete_sort_weight.php?weight=8';
