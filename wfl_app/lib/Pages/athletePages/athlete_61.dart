...
class W61 extends StatefulWidget {
  const W61({Key key}) : super(key: key);

  @override
  _W61 createState() => _W61();
}
...
class _W61 extends State<W61> {
  List<Athlete> _notes = List<Athlete>();

  Future<List<Athlete>> fetchNotes() async {
    var url = 'http://superfighter.nl/APP_output_athlete_sort_weight.php?weight=7';
