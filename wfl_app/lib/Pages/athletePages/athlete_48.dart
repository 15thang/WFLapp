...
class W48 extends StatefulWidget {
  const W48({Key key}) : super(key: key);

  @override
  _W48 createState() => _W48();
}
...
class _W48 extends State<W48> {
  List<Athlete> _notes = List<Athlete>();

  Future<List<Athlete>> fetchNotes() async {
    var url = 'http://superfighter.nl/APP_output_athlete_sort_weight.php?weight=10';
