...
class W95 extends StatefulWidget {
  const W95({Key key}) : super(key: key);

  @override
  _W95 createState() => _W95();
}
...
class _W95 extends State<W95> {
  List<Athlete> _notes = List<Athlete>();

  Future<List<Athlete>> fetchNotes() async {
    var url = 'http://superfighter.nl/APP_output_athlete_sort_weight.php?weight=2';
