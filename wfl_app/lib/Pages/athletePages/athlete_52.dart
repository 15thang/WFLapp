...
class W52 extends StatefulWidget {
  const W52({Key key}) : super(key: key);

  @override
  _W52 createState() => _W52();
}
...
class _W52 extends State<W52> {
  List<Athlete> _notes = List<Athlete>();

  Future<List<Athlete>> fetchNotes() async {
    var url = 'http://superfighter.nl/APP_output_athlete_sort_weight.php?weight=9';
