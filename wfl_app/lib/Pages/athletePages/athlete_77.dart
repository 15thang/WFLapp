...
class W77 extends StatefulWidget {
  const W77({Key key}) : super(key: key);

  @override
  _W77 createState() => _W77();
}
...
class _W77 extends State<W77> {
  List<Athlete> _notes = List<Athlete>();

  Future<List<Athlete>> fetchNotes() async {
    var url = 'http://superfighter.nl/APP_output_athlete_sort_weight.php?weight=4';
