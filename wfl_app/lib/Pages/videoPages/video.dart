...
import 'video_live_page.dart';
import 'video_past_page.dart';
...
class _EventPageState extends State<EventPage>
  ...
  final List<Tuple3> _pages = [
    Tuple3('Livestreams', Livestreams(), Icon(Icons.video_library)),
    Tuple3('Past Videos', PastVideos(), Icon(Icons.image)),
  ];
