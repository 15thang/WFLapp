...
class PastCompetitionPage extends StatefulWidget {
  const PastCompetitionPage({Key key}) : super(key: key);

  @override
  _PastCompetitionPageState createState() => _PastCompetitionPageState();
}
...
class _PastCompetitionPageState extends State<PastCompetitionPage> {
  List<Competitions> _notes = List<Competitions>();

  Future<List<Competitions>> fetchNotes() async {
    var url = 'http://superfighter.nl/APP_output_past_competition.php';
